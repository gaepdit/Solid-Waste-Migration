...
set  SUB_FORM_XML= (select replace(cast(TempXML.Node.query('data(value)') as varchar(max)),'SEMINOLE ROAD LANDFILL',' 
   ...
   <GOVf2148>
      ...
      <rptWaste>
         ...
         <txtTons>2.74</txtTons>
							...
							FROM 		
							[GovOnline_LEMIR].[GOV].[SUB_FORM]    
							cross apply
							SUB_FORM_XML.nodes('//dataField') TempXML (Node) 
						Where SUB_Form_RID=448353 AND SUBMISSION_RID=554845 AND cast(TempXML.Node.query('data(id)') as varchar(1000))='txtFacilityName')


						
Where SUB_Form_RID=448353 AND SUBMISSION_RID=554845
   ...
   <GOVf2148>
      ...
      <rptWaste>
         ...
         <txtTons>2.34</txtTons>
							...
							cross apply
							SUB_FORM_XML.nodes('//dataField') TempXML (Node) 
						Where SUB_Form_RID=448474 AND SUBMISSION_RID=554936 AND cast(TempXML.Node.query('data(id)') as varchar(1000))='txtFacilityName')


						
Where SUB_Form_RID=448474 AND SUBMISSION_RID=554936 
-------------------------  Query 3--------------------------------------------------------------------------
UPDATE [GovOnline_LEMIR].[GOV].[SUB_FORM]
set  SUB_FORM_XML= (select replace(cast(TempXML.Node.query('data(value)') as varchar(max)),'SEMINOLE ROAD LANDFILL','
   ...
   <GOVf2148>
      ...
      <rptWaste>
         ...
         <txtTons>0.91</txtTons>
							...
							cross apply
							SUB_FORM_XML.nodes('//dataField') TempXML (Node) 
						Where SUB_Form_RID=448483 AND SUBMISSION_RID=554945 AND cast(TempXML.Node.query('data(id)') as varchar(1000))='txtFacilityName')


						
Where SUB_Form_RID=448483 AND SUBMISSION_RID=554945	
------------------------------------------ QUERY 4--------------------------------------------------------------
UPDATE [GovOnline_LEMIR].[GOV].[SUB_FORM]
set  SUB_FORM_XML= (select replace(cast(TempXML.Node.query('data(value)') as varchar(max)),'SEMINOLE ROAD LANDFILL','
<DynamicFormValue>
   <GOVf2148>
      ...
      <rptWaste>
         ...
         <txtTons>1.43</txtTons>
							...
							cross apply
							SUB_FORM_XML.nodes('//dataField') TempXML (Node) 
						Where SUB_Form_RID=451357 AND SUBMISSION_RID=557193 AND cast(TempXML.Node.query('data(id)') as varchar(1000))='txtFacilityName')


						
Where SUB_Form_RID=451357 AND SUBMISSION_RID=557193   
