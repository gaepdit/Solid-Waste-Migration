...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[EI_BIO]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[EI_BIO](
    ...
    [chkRelatedEnvInterestV] [varchar](50)  NULL,
    [chkRelatedEnvInterestH] [varchar](50)  NULL,
