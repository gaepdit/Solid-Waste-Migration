...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[EI_OPBR]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[EI_OPBR](
    ...
    [ddlOtherPBRTypeV] [varchar](50)  NULL,
    [ddlOtherPBRTypeH] [varchar](50)  NULL,
    [txtOtherPBRType_OtherV] [varchar](50)  NULL,
    [txtOtherPBRType_OtherH] [varchar](50)  NULL,
