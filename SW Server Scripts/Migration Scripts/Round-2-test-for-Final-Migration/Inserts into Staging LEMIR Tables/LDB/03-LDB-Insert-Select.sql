...
AND [MFI].[MainPermitNumber] not in ('025-041D(LI)','025-073P(RM)','036-010D(SL)','036-010D(SL)(1)','036-010D(SL1)(1)','034-005D(SL)','025-073P(RM)','025-041D(LI)(4)','146-011D(LI)','150-009D(SL)','150-009D(LI)','146-011D(LI)')
ORDER BY 8                
