...
GO
DELETE FROM [dbo].[EI_CCRSI]
GO
DELETE FROM [dbo].[EI_CD]
GO
DELETE FROM [dbo].[EI_CI]
GO
DELETE FROM [dbo].[EI_CO]
GO
...
GO
DELETE FROM [dbo].[EI_OPBR]
GO
DELETE FROM [dbo].[EI_OPD]
GO
DELETE FROM [dbo].[EI_TS]
GO
DELETE FROM [dbo].[EI_TT]
GO
DELETE FROM [dbo].[EI_YTL]
GO
