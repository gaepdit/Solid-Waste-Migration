...
UPDATE [dbo].[EI_TYPE]
   SET [dbo].[EI_TYPE].[LEMIR_XML]=
    ...
    (SELECT DISTINCT
     ...
     FROM [LEMIR_Stage].[dbo].[EI_CO] AS [C]
    ...
    (SELECT DISTINCT
            [C].[chkCompostingClass_ID] AS [id],
            [C].[chkCompostingClass_VAL] AS [value],
            [C].[chkCompostingClass_TAG] AS [tag],
            [C].[chkCompostingClass_VIS] AS [visible],
            [C].[chkCompostingClass_HIS] AS [history],
            [C].[chkCompostingClass_DES] AS [description],
            [C].[chkCompostingClass_COM] AS [comment]
     FROM [LEMIR_Stage].[dbo].[EI_CO] AS [C]
          INNER JOIN [LEMIR_Stage].[dbo].[EI_TYPE] AS [I] ON [C].[PermitNumber] = [I].[PermitNumber]
     WHERE [C].[PermitNumber] = [EI].[PermitNumber] FOR XML PATH('dataField'), TYPE) AS [*],
     --[chkFeedstockCategories_ID]
    (SELECT DISTINCT
            [C].[chkFeedstockCategories_ID] AS [id],
            [C].[chkFeedstockCategories_VAL] AS [value],
            [C].[chkFeedstockCategories_TAG] AS [tag],
            [C].[chkFeedstockCategories_VIS] AS [visible],
            [C].[chkFeedstockCategories_HIS] AS [history],
            [C].[chkFeedstockCategories_DES] AS [description],
            [C].[chkFeedstockCategories_COM] AS [comment]
     FROM [LEMIR_Stage].[dbo].[EI_CO] AS [C]
          INNER JOIN [LEMIR_Stage].[dbo].[EI_TYPE] AS [I] ON [C].[PermitNumber] = [I].[PermitNumber]
     WHERE [C].[PermitNumber] = [EI].[PermitNumber] FOR XML PATH('dataField'), TYPE) AS [*],
     --[txtFeedstockTypes_ID]
    (SELECT DISTINCT
            [C].[txtFeedstockTypes_ID] AS [id],
            [C].[txtFeedstockTypes_VAL] AS [value],
            [C].[txtFeedstockTypes_TAG] AS [tag],
            [C].[txtFeedstockTypes_VIS] AS [visible],
            [C].[txtFeedstockTypes_HIS] AS [history],
            [C].[txtFeedstockTypes_DES] AS [description],
            [C].[txtFeedstockTypes_COM] AS [comment]
     FROM [LEMIR_Stage].[dbo].[EI_CO] AS [C]
          INNER JOIN [LEMIR_Stage].[dbo].[EI_TYPE] AS [I] ON [C].[PermitNumber] = [I].[PermitNumber]
     WHERE [C].[PermitNumber] = [EI].[PermitNumber] FOR XML PATH('dataField'), TYPE) AS [*],
     --[txtCompostingMethod_ID]
    (SELECT DISTINCT
            [C].[txtCompostingMethod_ID] AS [id],
            [C].[txtCompostingMethod_VAL] AS [value],
            [C].[txtCompostingMethod_TAG] AS [tag],
            [C].[txtCompostingMethod_VIS] AS [visible],
            [C].[txtCompostingMethod_HIS] AS [history],
            [C].[txtCompostingMethod_DES] AS [description],
            [C].[txtCompostingMethod_COM] AS [comment]
     FROM [LEMIR_Stage].[dbo].[EI_CO] AS [C]
          INNER JOIN [LEMIR_Stage].[dbo].[EI_TYPE] AS [I] ON [C].[PermitNumber] = [I].[PermitNumber]
     WHERE [C].[PermitNumber] = [EI].[PermitNumber] FOR XML PATH('dataField'), TYPE) AS [*],
     --[txtCompostingPadType_ID]
    (SELECT DISTINCT
            [C].[txtCompostingPadType_ID] AS [id],
            [C].[txtCompostingPadType_VAL] AS [value],
            [C].[txtCompostingPadType_TAG] AS [tag],
            [C].[txtCompostingPadType_VIS] AS [visible],
            [C].[txtCompostingPadType_HIS] AS [history],
            [C].[txtCompostingPadType_DES] AS [description],
            [C].[txtCompostingPadType_COM] AS [comment]
     FROM [LEMIR_Stage].[dbo].[EI_CO] AS [C]
          INNER JOIN [LEMIR_Stage].[dbo].[EI_TYPE] AS [I] ON [C].[PermitNumber] = [I].[PermitNumber]
     WHERE [C].[PermitNumber] = [EI].[PermitNumber] FOR XML PATH('dataField'), TYPE) AS [*],
     --[txtActiveCompostingArea_ID]
    (SELECT DISTINCT
            [C].[txtActiveCompostingArea_ID] AS [id],
            [C].[txtActiveCompostingArea_VAL] AS [value],
            [C].[txtActiveCompostingArea_TAG] AS [tag],
            [C].[txtActiveCompostingArea_VIS] AS [visible],
            [C].[txtActiveCompostingArea_HIS] AS [history],
            [C].[txtActiveCompostingArea_DES] AS [description],
            [C].[txtActiveCompostingArea_COM] AS [comment]
     FROM [LEMIR_Stage].[dbo].[EI_CO] AS [C]
          INNER JOIN [LEMIR_Stage].[dbo].[EI_TYPE] AS [I] ON [C].[PermitNumber] = [I].[PermitNumber]
     WHERE [C].[PermitNumber] = [EI].[PermitNumber] FOR XML PATH('dataField'), TYPE) AS [*],
    ...
    (SELECT DISTINCT
     ...
     FROM [LEMIR_Stage].[dbo].[EI_CO] AS [B]
    ...
    (SELECT DISTINCT
     ...
     FROM [dbo].[EI_TYPE] AS [EI]
          INNER JOIN [dbo].[EI_CO] AS [C] ON [EI].[PermitNumber] = [C].[PermitNumber]
     WHERE [EI].[PermitNumber] = [E].[PermitNumber] FOR XML PATH('SolidWaste'), ROOT('DynamicFormValue'))
     --EI Where clause
FROM [dbo].[EI_TYPE] AS [E]
     INNER JOIN [dbo].[EI_CO] AS [CD] ON [E].[PermitNumber] = [CD].[PermitNumber]
WHERE [E].[LEMIR_EI_CD] = 'CO'
