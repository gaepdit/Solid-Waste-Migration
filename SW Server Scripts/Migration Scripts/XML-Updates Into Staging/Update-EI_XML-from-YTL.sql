...
UPDATE [dbo].[EI_TYPE]
   SET [dbo].[EI_TYPE].[LEMIR_XML]=
    ...
    (SELECT DISTINCT
     ...
     FROM [LEMIR_Stage].[dbo].[EI_YTL] AS [C]
    ...
    (SELECT DISTINCT
            [C].[txtDisposalFootprint_ID] AS [id],
            [C].[txtDisposalFootprint_VAL] AS [value],
            [C].[txtDisposalFootprint_TAG] AS [tag],
            [C].[txtDisposalFootprint_VIS] AS [visible],
            [C].[txtDisposalFootprint_HIS] AS [history],
            [C].[txtDisposalFootprint_DES] AS [description],
            [C].[txtDisposalFootprint_COM] AS [comment]
     FROM [LEMIR_Stage].[dbo].[EI_YTL] AS [C]
          INNER JOIN [LEMIR_Stage].[dbo].[EI_TYPE] AS [I] ON [C].[PermitNumber] = [I].[PermitNumber]
     WHERE [C].[PermitNumber] = [EI].[PermitNumber] FOR XML PATH('dataField'), TYPE) AS [*],
    ...
    (SELECT DISTINCT
     ...
     FROM [LEMIR_Stage].[dbo].[EI_YTL] AS [B]
     ...
     FROM [dbo].[EI_TYPE] AS [EI]
          INNER JOIN [dbo].[EI_YTL] AS [C] ON [EI].[PermitNumber] = [C].[PermitNumber]
     WHERE [EI].[PermitNumber] = [E].[PermitNumber] FOR XML PATH('SolidWaste'), ROOT('DynamicFormValue'))
     --EI Where clause
FROM [dbo].[EI_TYPE] AS [E]
     INNER JOIN [dbo].[EI_YTL] AS [LI] ON [E].[PermitNumber] = [LI].[PermitNumber]
WHERE [E].[LEMIR_EI_CD] = 'YTL'
