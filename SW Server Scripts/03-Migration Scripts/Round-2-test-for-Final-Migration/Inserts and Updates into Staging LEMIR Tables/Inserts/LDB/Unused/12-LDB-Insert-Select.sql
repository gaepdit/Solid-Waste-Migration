...
WHERE [UI].[InsUpd] = 'I'
      ...
      --AND [ST].[FACILITY_ID_REF] LIKE 'SW-FAC-%'
      --AND [FC].[FACILITY_ID_REF] LIKE 'SW-FAC-%';
--
--
...
FROM [LEMIR_Stage].[dbo].[FAC_FACILITY] AS [FF]
     JOIN [LEMIR_Stage].[dbo].[SYS_CONTACT] AS [FC] ON [FF].[FACILITY_ID_REF] = [FC].[FACILITY_ID_REF]
...
WHERE [UI].[InsUpd] = 'I'
      ...
      AND [FC].[CREATED_BY] = @created_by_string;
      --AND [FF].[FACILITY_ID_REF] LIKE 'SW-FAC-%'
      --AND [FC].[FACILITY_ID_REF] LIKE 'SW-FAC-%';