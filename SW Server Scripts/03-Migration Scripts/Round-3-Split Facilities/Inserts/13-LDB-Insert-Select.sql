...
FROM [LEMIR_Stage].[dbo].[FAC_FACILITY] AS [FF]
     LEFT JOIN [LEMIR_Stage].[dbo].[EI_TYPE] AS [EIT] ON [FF].[FACILITY_ID_REF] = [EIT].[PermitNumber]
     JOIN [LandDatabase].[dbo].[MAIN FACILITY INFO] AS [MFI] ON [FF].[FACILITY_ID_REF] = [MFI].[MainPermitNumber]
