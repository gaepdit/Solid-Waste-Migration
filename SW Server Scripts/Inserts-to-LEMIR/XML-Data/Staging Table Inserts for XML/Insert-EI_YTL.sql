...
SELECT [PermitNumber],
       --
      [MF].[PermitNumber] AS [PermitNumber],
       --
      ...
      'txtPBRApprovalDate' AS [txtPBRApprovalDate_ID],
       ...
       --
       'txtDisposalFootprint' AS [txtDisposalFootprint_ID],
       '' AS [txtDisposalFootprint_VAL],
       'Disposal Footprint (acres)' AS [txtDisposalFootprint_TAG],
       'true' AS [txtDisposalFootprint_VIS],
       '' AS [txtDisposalFootprint_HIS],
