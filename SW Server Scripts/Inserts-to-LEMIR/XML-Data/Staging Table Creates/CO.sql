...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[EI_CO') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[EI_CO](
    ...
    [chkCompostingClassV] [varchar](50)  NULL,
    [chkCompostingClassH] [varchar](50)  NULL,
    [chkFeedstockCategoriesV] [varchar] (50)  NULL,
	[chkFeedstockCategoriesH] [varchar] (50)  NULL,
	[txtFeedstockTypesV] [varchar](50)  NULL,
    [txtFeedstockTypesH] [varchar](50)  NULL,
    [txtCompostingMethodV] [varchar](50)  NULL,
    [txtCompostingMethodH] [varchar](50)  NULL,
    [txtCompostingPadTypeV] [varchar](50)  NULL,
    [txtCompostingPadTypeH] [varchar](50)  NULL,
    [txtActiveCompostingAreaV] [varchar](50)  NULL,
    [txtActiveCompostingAreaH] [varchar](50)  NULL,
