...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[EI_LSF]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[EI_LSF](
    ...
    [txtSolidificationPitDescV] [varchar] (50)  NULL,
	[txtSolidificationPitDescH] [varchar] (50)  NULL,
	[rdoLeakDetectionSystemV] [varchar](50)  NULL,
    [rdoLeakDetectionSystemH] [varchar](50)  NULL,
