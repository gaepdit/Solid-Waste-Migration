...
/*********************************************
*** Create Table in LEMIR_Stage for EI BIO ***
*********************************************/
...
IF EXISTS
    (SELECT *
     FROM [sys].[objects]
     WHERE object_id = OBJECT_ID(N'[dbo].[EI_BIO]')
           AND [type] IN(N'U'))
  BEGIN
...
CREATE TABLE [dbo].[EI_BIO]
      ...
      --DataField
             ...
             [rdoGWInstalled_HIS]                VARCHAR(100) NULL,
      ...
      --DataField>
             ...
             [rdoMethaneInstalled_HIS]           VARCHAR(100) NULL,
