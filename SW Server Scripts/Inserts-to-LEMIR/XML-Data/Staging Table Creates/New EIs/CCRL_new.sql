...
/***********************************************
*** Create Table in LEMIR_Stage for EI_CCRL  ***
***********************************************/
...
IF EXISTS
    (SELECT *
     FROM [sys].[objects]
     WHERE object_id = OBJECT_ID(N'[dbo].[EI_CCRL]')
           AND [type] IN(N'U'))
  BEGIN
...
CREATE TABLE [dbo].[EI_CCRL]
      ...
      --Datafield
       ...
       --DataField
             ...
             [txtWebsiteAddress_VAL]               VARCHAR(100) NULL,
             [txtWebsiteAddress_TAG]               VARCHAR(100) NULL,
             [txtWebsiteAddress_VIS]               VARCHAR(100) NULL,
             [txtWebsiteAddress_HIS]               VARCHAR(1000) NULL,
             [txtWebsiteAddress_DES]               VARCHAR(100) NULL,
             [txtWebsiteAddress_COM]               VARCHAR(200) NULL,
        -- Datafield
