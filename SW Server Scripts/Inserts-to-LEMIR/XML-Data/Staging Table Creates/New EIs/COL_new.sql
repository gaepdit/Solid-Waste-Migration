...
/**********************************************
*** Create Table in LEMIR_Stage for EI_COL  ***
**********************************************/
...
IF EXISTS
    (SELECT *
     FROM [sys].[objects]
     WHERE object_id = OBJECT_ID(N'[dbo].[EI_COL]')
           AND [type] IN(N'U'))
  BEGIN
...
CREATE TABLE [dbo].[EI_COL]
      ...
      -- Datafield
        ...
        --DataField
             ...
             [txtSolidWasteHandled_VAL]       VARCHAR(100) NULL,
             [txtSolidWasteHandled_TAG]       VARCHAR(100) NULL,
             [txtSolidWasteHandled_VIS]       VARCHAR(100) NULL,
             [txtSolidWasteHandled_HIS]       VARCHAR(1000) NULL,
             [txtSolidWasteHandled_DES]       VARCHAR(100) NULL,
             [txtSolidWasteHandled_COM]       VARCHAR(200) NULL,
        --DataField
