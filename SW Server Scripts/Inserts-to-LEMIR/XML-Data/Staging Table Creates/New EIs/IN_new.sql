...
/*********************************************
*** Create Table in LEMIR_Stage for EI_IN  ***
*********************************************/
...
IF EXISTS
    (SELECT *
     FROM [sys].[objects]
     WHERE object_id = OBJECT_ID(N'[dbo].[EI_IN]')
           AND [type] IN(N'U'))
  BEGIN
...
CREATE TABLE [dbo].[EI_IN]
      ...
      -- Datafield
        ...
        --DataField
             ...
             [ddlInertLandfillType_VAL]            VARCHAR(100) NULL,
             [ddlInertLandfillType_TAG]            VARCHAR(100) NULL,
             [ddlInertLandfillType_VIS]            VARCHAR(100) NULL,
             [ddlInertLandfillType_HIS]            VARCHAR(1000) NULL,
             [ddlInertLandfillType_DES]            VARCHAR(100) NULL,
             [ddlInertLandfillType_COM]            VARCHAR(200) NULL,
        --DataField
