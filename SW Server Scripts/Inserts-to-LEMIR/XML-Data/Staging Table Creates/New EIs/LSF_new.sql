...
/**********************************************
*** Create Table in LEMIR_Stage for EI_LSF  ***
**********************************************/
...
IF EXISTS
    (SELECT *
     FROM [sys].[objects]
     WHERE object_id = OBJECT_ID(N'[dbo].[EI_LSF]')
           AND [type] IN(N'U'))
  BEGIN
