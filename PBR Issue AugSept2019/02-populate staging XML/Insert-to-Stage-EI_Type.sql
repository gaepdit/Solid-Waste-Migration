...
SELECT isnull([MFI].[MainPermitNumber], [MF].[PermitNumber]) AS [PermitNumber],
       [LEMIR_EI_RID]=CASE
                        WHEN [MFI].[MainPermitNumber] IN('031-041P','060-082P(DW)')
                        --('009-006P', '011-027P', '025-073P', '033-096P', '033-097P', '060-093(P)', '121-019P', '067-038P', '092-023P', '105-015P', '129-013P',
                          THEN 10041 --LS
                        ...
                        --        AND [MFI].[FacilityTypeDescription] = 'Processor-Compostor')
                        --  THEN 10042 --CO
                        WHEN [MFI].[MainPermitNumber] IN('002-008P(RM)','006-008P(RM)','011-021P(RM)','011-024P(RM)','025-032P(RMI)','069-010P(RM)','078-008P(RMI)','047-022P(RM)(I)','058-011P(RM)','059-011P','134-013P(RMI)','032-005P(RM)','033-093P(RM)','035-014P(RM)','121-005P(RMI)','078-008(RMI)')
                        --([MFI].[FacilityType] = 'CO;MRF'
                        ...
                        --        AND [MFI].[FacilityTypeDescription] = 'Industrial Landfill')
                        --  THEN 10050 --LI
                        WHEN [MFI].[MainPermitNumber] = '025-059P(INC)'
                        --([MFI].[FacilityType] = 'ACD'
                        ...
                        --  THEN 10055 --TS
                        WHEN [MFI].[MainPermitNumber] IN('067-036(CI)','087-013(CI)','057-015(CI)','025-069(CI)','029-010(CI)','033-094(CI)')
                        --([MFI].[FacilityType] = 'CI'
                        ...
                        --  THEN 10056 --YTL
                        WHEN [MFI].[MainPermitNumber] ='031-038P'
                        --[MF].[FacilityType] IN('COMP', 'OSP', 'OSTT')
                          THEN 10057 --PBR-OTH
                        ELSE 0
                      END,
       [LEMIR_EI_CD]=CASE
                       ...
                       --  THEN 'CO'
                       WHEN [MFI].[MainPermitNumber] IN('002-008P(RM)','006-008P(RM)','011-021P(RM)','011-024P(RM)','025-032P(RMI)','069-010P(RM)','078-008P(RMI)','047-022P(RM)(I)','058-011P(RM)','059-011P','134-013P(RMI)','032-005P(RM)','033-093P(RM)','035-014P(RM)','121-005P(RMI)','078-008(RMI)')
                       --[MFI].[MainPermitNumber] IN('031-041P','060-082P(DW)')
                       --([MFI].[FacilityType] = 'CO;MRF'
                       --     AND [MFI].[FacilityTypeDescription] = 'Composting;Materials Recovery Facility')
                       --    OR ([MFI].[FacilityType] = 'MRF'
                       --        AND [MFI].[FacilityTypeDescription] = 'Materials Recovery Facility')
...
FROM [LandDatabase].[dbo].[MAIN FACILITY INFO] AS [MFI]
     ...
     WHERE isnull([MFI].[MainPermitNumber], [MF].[PermitNumber]) IN ('031-041P','060-082P(DW)','002-008P(RM)','006-008P(RM)','011-021P(RM)','011-024P(RM)','025-032P(RMI)','069-010P(RM)','078-008P(RMI)','047-022P(RM)(I)','058-011P(RM)','059-011P','134-013P(RMI)','032-005P(RM)','033-093P(RM)','035-014P(RM)','121-005P(RMI)','031-041P','060-082P(DW)','025-059P(INC)','067-036(CI)','087-013(CI)','057-015(CI)','025-069(CI)','029-010(CI)','033-094(CI)','031-038P')
