...
--
SET @rid_counter_start = 742171;  -- current Max RID - 4/27/20
--
--IF 'EPDMIG SW OB' =
--    (SELECT [CREATED_BY]
--     FROM [LEMIR_Stage_OB].[dbo].[SYS_ENV_PROGRAM_CONTACT_DUTY]
...
-- DONE
--
--INSERT INTO [LEMIR_Stage_OB].[dbo].[SYS_ENV_PROGRAM_CONTACT_DUTY]
...
FROM [LEMIR_Stage_OB].[dbo].[SYS_ENV_PROGRAM_CONTACT] AS [SEPC]
     JOIN [LEMIR_Stage_OB].[dbo].[SYS_CONTACT] AS [SC] ON [SC].[CONTACT_RID] = [SEPC].[CONTACT_RID]
