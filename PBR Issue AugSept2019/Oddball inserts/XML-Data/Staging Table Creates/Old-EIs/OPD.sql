...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[EI_OPD') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[EI_OPD](
    ...
    [ddlOperationTypeV] [varchar](50)  NULL,
    [ddlOperationTypeH] [varchar](50)  NULL,
