...
--
SET @rid_counter_start = 1292974; -- cureent Max RID - 5/1/20   PROD
--
--IF 'EPDMIG SW' =
--    (SELECT [SPL].[CREATED_BY]
--     FROM [LEMIR_Stage_OB].[dbo].[SYS_PHYSICAL_LOCATION] AS [SPL]
...
--  BEGIN
  ...
  --
--INSERT INTO [LEMIR_Stage_OB].[dbo].[SYS_PHYSICAL_LOCATION]
--       ([LOCATION_RID],
--        [LOCATION_DESC],
--        [ST_NO],
--        [ST_DIRECTION_RID],
...
FROM [LandDataBase].[dbo].[MAIN FACILITY INFO] AS [MFI]
     ...
     LEFT JOIN [LEMIR_Stage_OB].[dbo].[SYS_GEO_COORDINATE] AS [SGC] ON [MFI].[MainPermitNumber] = [SGC].[FACILITY_ID_REF]
