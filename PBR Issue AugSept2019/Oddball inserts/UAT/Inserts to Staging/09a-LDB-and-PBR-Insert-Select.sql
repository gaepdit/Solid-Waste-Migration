...
--
--INSERT INTO [LEMIR_Stage_OB].[dbo].[SYS_CONTACT_ADDRESS]
--       ([CONTACT_RID],
--        [ADDRESS_RID],
--        [STATUS_CD],
--        [CREATED_BY],
...
SELECT [SC].[CONTACT_RID] AS [CONTACT_RID],
       ...
       [SC].[FACILITY_ID_REF]
FROM [LEMIR_Stage_OB].[dbo].[SYS_ADDRESS] AS [SA]
     JOIN [LEMIR_Stage_OB].[dbo].[SYS_CONTACT] AS [SC] ON [SA].[FACILITY_ID_REF] = [SC].[FACILITY_ID_REF]
