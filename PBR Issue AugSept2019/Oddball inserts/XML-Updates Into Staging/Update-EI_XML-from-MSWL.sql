...
UPDATE [dbo].[EI_TYPE]
   SET [dbo].[EI_TYPE].[LEMIR_XML]=
    ...
    (SELECT DISTINCT
     ...
     FROM [LEMIR_Stage_OB].[dbo].[EI_MSWL] AS [C]
          INNER JOIN [LEMIR_Stage_OB].[dbo].[EI_TYPE] AS [I] ON [C].[PermitNumber] = [I].[PermitNumber]
    ...
    (SELECT DISTINCT
     ...
     FROM [LEMIR_Stage_OB].[dbo].[EI_MSWL] AS [B]
          INNER JOIN [LEMIR_Stage_OB].[dbo].[EI_TYPE] AS [I] ON [B].[PermitNumber] = [I].[PermitNumber]
    ...
    (SELECT DISTINCT
     ...
     FROM [LEMIR_Stage_OB].[dbo].[$grdClosure] AS [C]
    ...
    (SELECT DISTINCT
     ...
     FROM [LEMIR_Stage_OB].[dbo].[$grdConstructionDetail] AS [C]
    ...
    (SELECT DISTINCT
     ...
     FROM [LEMIR_Stage_OB].[dbo].[$grdMajorModification] AS [M]
