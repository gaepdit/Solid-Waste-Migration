...
SELECT [MFI].[MainPermitNumber] AS [PermitNumber],
       ...
       --
       'chkCompostingClass' AS [chkCompostingClass_ID],
       '' AS [chkCompostingClass_VAL],
       'Composting Class' AS [chkCompostingClass_TAG],
       'true' AS [chkCompostingClass_VIS],
       '' AS [chkCompostingClass_HIS],
       'Composting Class:' AS [chkCompostingClass_DES],
       '' AS [chkCompostingClass_COM],
       --
       'chkFeedstockCategories' AS [chkFeedstockCategories_ID],
       '' AS [chkFeedstockCategories_VAL],
       'Feedstock Categories' AS [chkFeedstockCategories_TAG],
       'true' AS [chkFeedstockCategories_VIS],
       '' AS [chkFeedstockCategories_HIS],
       'Feedstock Categories:' AS [chkFeedstockCategories_DES],
       '' AS [chkFeedstockCategories_COM],
       --
       'txtFeedstockTypes' AS [txtFeedstockTypes_ID],
       '' AS [txtFeedstockTypes_VAL],
       'Feedstock Types' AS [txtFeedstockTypes_TAG],
       'true' AS [txtFeedstockTypes_VIS],
       '' AS [txtFeedstockTypes_HIS],
       'Feedstock Types:' AS [txtFeedstockTypes_DES],
       '' AS [txtFeedstockTypes_COM],
       --
       'txtCompostingMethod' AS [txtCompostingMethod_ID],
       '' AS [txtCompostingMethod_VAL],
       'Composting Method' AS [txtCompostingMethod_TAG],
       'true' AS [txtCompostingMethod_VIS],
       '' AS [txtCompostingMethod_HIS],
       'Composting Method:' AS [txtCompostingMethod_DES],
       '' AS [txtCompostingMethod_COM],
       --
       'txtCompostingPadType' AS [txtCompostingPadType_ID],
       '' AS [txtCompostingPadType_VAL],
       'Composting Pad Type' AS [txtCompostingPadType_TAG],
       'true' AS [txtCompostingPadType_VIS],
       '' AS [txtCompostingPadType_HIS],
       'Composting Pad Type:' AS [txtCompostingPadType_DES],
       '' AS [txtCompostingPadType_COM],
       --
       'txtActiveCompostingArea' AS [txtActiveCompostingArea_ID],
       '' AS [txtActiveCompostingArea_VAL],
       'Active Composting Area (acres)' AS [txtActiveCompostingArea_TAG],
       'true' AS [txtActiveCompostingArea_VIS],
       '' AS [txtActiveCompostingArea_HIS],
       'Active Composting Area (acres):' AS [txtActiveCompostingArea_DES],
       '' AS [txtActiveCompostingArea_COM],
       --
