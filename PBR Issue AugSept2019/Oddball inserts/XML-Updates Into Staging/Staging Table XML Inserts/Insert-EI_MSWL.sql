...
WHERE [FYReportingYear] IS NOT NULL
      AND [permitnumber] IN('028-040D(C&D)', '124-005D(MSWL)', '136-014D(L)', '136-018D(MSWL)', '148-009D(MSWL)', '150-010D(MSWL)', '134-009D(SL)')
ORDER BY 1;
--SELECT *
--FROM [#latestYear];
--
...
WHERE [EI].[LEMIR_EI_CD] = 'MSWL'
      AND [MFI].[MainPermitNumber] IN('028-040D(C&D)', '124-005D(MSWL)', '136-014D(L)', '136-018D(MSWL)', '148-009D(MSWL)', '150-010D(MSWL)', '134-009D(SL)')
GO
