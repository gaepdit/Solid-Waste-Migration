...
WHERE [FF].[FACILITY_RID] IN(2345902, 345903, 345909, 160596, 350994)
      --OR [FF].[FACILITY_RID] IN(349953, 350704, 350703, 350693, 350705)
      --WHERE [FF].[FACILITY_IDENTIFIER] = '155-049P(RM)'
ORDER BY 2
