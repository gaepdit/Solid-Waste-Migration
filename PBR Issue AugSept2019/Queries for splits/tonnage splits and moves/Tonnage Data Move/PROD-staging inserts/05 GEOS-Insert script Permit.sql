...
When        Who                 What
----------  ------------------  ----------------------------------------
03/12/20    Tom Karasch         Modified for used with Solid Waste UAT
04/14/2020  Tom Karasch         Modified script to use for PROD
***********************************************************************/
...
SET @rid_counter_start=936665 + 1000

  -- ************** Change SYS_FACILITY_RID to FAC_RID ******************************************
  --
...
FROM [LEMIR_Stage].[dbo].[$1_GEOS_FAC_FACILITY] AS [FF]
     ...
     LEFT JOIN [GovOnline_LEMIR].[GOV].[SUB_PERMIT] AS [GSP] ON [FF].[FACILITY_IDENTIFIER] = [GSP].[PERMIT_NUMBER]
