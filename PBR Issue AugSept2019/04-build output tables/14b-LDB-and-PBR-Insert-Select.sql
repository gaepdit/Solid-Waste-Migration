...
--
SET @rid_counter_start = 709400;  -- current Max RID - 5/21/19
--
--IF 'EPDMIG SW' =
--    (SELECT [CREATED_BY]
--     FROM [LEMIR_Stage].[dbo].[SYS_ENV_PROGRAM_CONTACT_DUTY]
...
-- DONE
--
--INSERT INTO [LEMIR_Stage_fixes].[dbo].[SYS_ENV_PROGRAM_CONTACT_DUTY]
...
FROM [LEMIR_Stage_fixes].[dbo].[SYS_ENV_PROGRAM_CONTACT] AS [SEPC]
