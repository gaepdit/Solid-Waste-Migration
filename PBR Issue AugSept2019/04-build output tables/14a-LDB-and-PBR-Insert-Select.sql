...
--
SET @rid_counter_start = 709500;  -- current Max RID less than dummy(728326) - 12/6/19
--
--IF 'EPDMIG SW' =
--    (SELECT [CREATED_BY]
...
--  END
  ...
  --  607931, 10046, 533880
  --
--INSERT INTO [LEMIR_Stage_fixes].[dbo].[SYS_ENV_PROGRAM_CONTACT]
